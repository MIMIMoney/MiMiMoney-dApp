package com.mimimoney.token.web;

import static com.mimimoney.token.tools.Convert.getEthString;
import static com.mimimoney.token.tools.ParseMagicLink.normal;
import static com.mimimoney.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;

import com.mimimoney.token.entity.Attribute;
import com.mimimoney.token.entity.AttributeInterface;
import com.mimimoney.token.entity.ContractAddress;
import com.mimimoney.token.entity.ContractInfo;
import com.mimimoney.token.entity.MagicLinkData;
import com.mimimoney.token.entity.MagicLinkInfo;
import com.mimimoney.token.entity.NonFungibleToken;
import com.mimimoney.token.entity.SalesOrderMalformed;
import com.mimimoney.token.entity.TokenScriptResult;
import com.mimimoney.token.entity.TransactionResult;
import com.mimimoney.token.tools.ParseMagicLink;
import com.mimimoney.token.tools.TokenDefinition;
import com.mimimoney.token.web.Ethereum.TokenscriptFunction;
import com.mimimoney.token.web.Ethereum.TransactionHandler;
import com.mimimoney.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.mimimoney\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://mimimoney.com");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using Mimimoney with WalletConnect, please launch the Mimimoney app";
        }
