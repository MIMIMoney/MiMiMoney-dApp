package com.mimimoney.token.web.Service;

import com.mimimoney.token.entity.SalesOrderMalformed;
import com.mimimoney.token.tools.Numeric;
...
import static com.mimimoney.token.web.Service.SpawnableLinkGenerator.bytesFromSignature;
...
public class EdconLinkGenerator {
    ...
    public static void main(String[] args) throws SalesOrderMalformed {
        int rounds = 50;
        while(rounds > 0) {
            new com.mimimoney.token.web.Service.EdconLinkGenerator(date, VIENNA, BLOCKCHAIN_HALL, 1);
            rounds--;
        }
    }
