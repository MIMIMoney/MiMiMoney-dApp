...
import com.mimimoney.token.util.DateTime;
import com.mimimoney.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'Mimimoney meetup indices' where 'Match' mapping is null but for FIFA is not.
