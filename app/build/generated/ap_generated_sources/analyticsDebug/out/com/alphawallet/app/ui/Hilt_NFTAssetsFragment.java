...
abstract class Hilt_NFTAssetsFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NFTAssetsFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectNFTAssetsFragment(UnsafeCasts.<NFTAssetsFragment>unsafeCast(this));
    }
  }
}
