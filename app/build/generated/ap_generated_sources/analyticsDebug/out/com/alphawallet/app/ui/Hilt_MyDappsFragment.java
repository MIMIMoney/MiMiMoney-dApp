...
abstract class Hilt_MyDappsFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyDappsFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectMyDappsFragment(UnsafeCasts.<MyDappsFragment>unsafeCast(this));
    }
  }
}
