...
abstract class Hilt_NFTInfoFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NFTInfoFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectNFTInfoFragment(UnsafeCasts.<NFTInfoFragment>unsafeCast(this));
    }
  }
}
