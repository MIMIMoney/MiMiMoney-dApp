...
abstract class Hilt_WalletTestFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WalletTestFragment() {
    super();
  }

  Hilt_WalletTestFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WalletTestFragment_GeneratedInjector) this.generatedComponent()).injectWalletTestFragment(UnsafeCasts.<WalletTestFragment>unsafeCast(this));
    }
  }
