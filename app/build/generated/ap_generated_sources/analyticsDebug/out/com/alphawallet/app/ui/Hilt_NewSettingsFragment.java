...
abstract class Hilt_NewSettingsFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewSettingsFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectNewSettingsFragment(UnsafeCasts.<NewSettingsFragment>unsafeCast(this));
    }
  }
}
