...
abstract class Hilt_TokenAlertsFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TokenAlertsFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectTokenAlertsFragment(UnsafeCasts.<TokenAlertsFragment>unsafeCast(this));
    }
  }
}
