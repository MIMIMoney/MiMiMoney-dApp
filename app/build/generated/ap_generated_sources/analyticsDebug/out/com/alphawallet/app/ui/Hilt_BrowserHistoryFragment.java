...
abstract class Hilt_BrowserHistoryFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BrowserHistoryFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectBrowserHistoryFragment(UnsafeCasts.<BrowserHistoryFragment>unsafeCast(this));
    }
  }
}
