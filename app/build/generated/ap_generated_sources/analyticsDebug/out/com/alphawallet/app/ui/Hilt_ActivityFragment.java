...
abstract class Hilt_ActivityFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActivityFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectActivityFragment(UnsafeCasts.<ActivityFragment>unsafeCast(this));
    }
  }
}
