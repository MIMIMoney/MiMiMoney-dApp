...
abstract class Hilt_DappBrowserFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DappBrowserFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectDappBrowserFragment(UnsafeCasts.<DappBrowserFragment>unsafeCast(this));
    }
  }
}
