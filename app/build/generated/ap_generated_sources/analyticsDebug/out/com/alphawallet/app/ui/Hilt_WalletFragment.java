...
abstract class Hilt_WalletFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WalletFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectWalletFragment(UnsafeCasts.<WalletFragment>unsafeCast(this));
    }
  }
}
