...
abstract class Hilt_TokenActivityFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TokenActivityFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectTokenActivityFragment(UnsafeCasts.<TokenActivityFragment>unsafeCast(this));
    }
  }
}
