...
abstract class Hilt_ImportPrivateKeyFragment extends ImportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportPrivateKeyFragment_GeneratedInjector) this.generatedComponent()).injectImportPrivateKeyFragment(UnsafeCasts.<ImportPrivateKeyFragment>unsafeCast(this));
    }
  }
