...
abstract class Hilt_ImportSeedFragment extends ImportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportSeedFragment_GeneratedInjector) this.generatedComponent()).injectImportSeedFragment(UnsafeCasts.<ImportSeedFragment>unsafeCast(this));
    }
  }
