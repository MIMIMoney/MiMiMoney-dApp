...
abstract class Hilt_SetWatchWalletFragment extends ImportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SetWatchWalletFragment_GeneratedInjector) this.generatedComponent()).injectSetWatchWalletFragment(UnsafeCasts.<SetWatchWalletFragment>unsafeCast(this));
    }
  }
