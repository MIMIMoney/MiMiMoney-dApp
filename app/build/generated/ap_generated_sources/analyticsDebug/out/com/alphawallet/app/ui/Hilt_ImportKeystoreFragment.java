...
abstract class Hilt_ImportKeystoreFragment extends ImportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportKeystoreFragment_GeneratedInjector) this.generatedComponent()).injectImportKeystoreFragment(UnsafeCasts.<ImportKeystoreFragment>unsafeCast(this));
    }
  }
