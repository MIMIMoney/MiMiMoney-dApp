...
abstract class Hilt_DiscoverDappsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DiscoverDappsFragment() {
    super();
  }

  Hilt_DiscoverDappsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiscoverDappsFragment_GeneratedInjector) this.generatedComponent()).injectDiscoverDappsFragment(UnsafeCasts.<DiscoverDappsFragment>unsafeCast(this));
    }
  }
